        ...
        <div className="grid lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
          {SERVICES.map((service, i) => (
            <div key={i} className="group border border-black/10 rounded-[16px] md:rounded-2xl p-5 sm:p-8 hover:bg-[#111] hover:text-white transition-all duration-300 cursor-pointer flex flex-col justify-between sm:aspect-square">
              <span className='w-8 sm:w-10 sm:h-10 rounded-full border border-current flex items-center justify-center self-end opacity-0 group-hover:opacity-100 transition-opacity text-sm sm:text-base'>
                ↗
              </span>
