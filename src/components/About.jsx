      ...
      >
        ...
        <div>
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <a href="#" className="font-body text-sm font-semibold text-[#111] border-2 border-[#111] rounded-full px-6 py-3 hover:bg-[#111] hover:text-white transition-colors flex items-center gap-1.5">
              Our Story <span>↗</span>
            </a>
            <a href="#" className="font-body text-sm font-semibold text-[#111] flex items-center gap-1.5 px-1 py-3 border-b border-transparent hover:border-[#111] transition-colors">
